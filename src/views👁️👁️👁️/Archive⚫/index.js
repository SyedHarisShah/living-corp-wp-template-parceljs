...
import podcast from 'bundle-text:./podcast.eta'
import learn from 'bundle-text:./learn.eta'
import article from 'bundle-text:./article.eta'
import network from 'bundle-text:./network.eta'
import show from 'bundle-text:./show.eta'
...
import learnlist from 'bundle-text:/src/views👁️👁️👁️/ETA/learn.eta'
import articlelist from 'bundle-text:/src/views👁️👁️👁️/ETA/art.eta'
...
export default class extends Page {
  ...
  async generate(content) {
    ...
    if(this.type=='podcast'){
      ...
      html = Eta.render(podcast,{global:this.main,footer:this.footer})
      ...
      html = Eta.render(learn,{global:this.main,footer:this.footer})
      document.querySelector('#content').innerHTML += html
      this.DOM = {
        el:document.querySelector('main:not(.old)')
      ...
      html = Eta.render(article,{global:this.main,footer:this.footer})
      document.querySelector('#content').innerHTML += html
      this.DOM = {
        el:document.querySelector('main:not(.old)')
  ...
  async getJson(url,isNew){
    ...
    if(this.type == 'post'){
      ...
      this.html = Eta.render(articlelist,{global:this.main,posts:datap.posts})
    }
      ...
      this.html = Eta.render(showlist,{global:this.main,posts:datap.posts})

    }
    else if(this.type=='network'){
      this.html = Eta.render(networklist,{global:this.main,posts:datap.posts})
    }
