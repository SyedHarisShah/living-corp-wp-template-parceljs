...
import list_eta from 'bundle-text:./list.eta'
...
export default class extends Page {
  ...
  addEvents(){
    ...
    this.DOM.searchbar.addEventListener('keydown', (e) => {
      if(e.key=='Enter' || e.code == 9 ||e.code == 13){
        this.search();
      }
    });
  ...
  async search(){
    ...
    right.innerHTML = getLoadingWheel();
    ...
    let html = Eta.render(list_eta,{ceos,icons: this.main.icons})
